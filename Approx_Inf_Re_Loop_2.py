...
# Import fake data
N = np.load('{}{}{}'.format('Nathan Fake ', lim, '/N.npy'))
M_est = np.load('{}{}{}'.format('Nathan Fake ', lim, '/M_est.npy'))
M_true = np.load('{}{}{}'.format('Nathan Fake ', lim, '/M_true.npy'))
dist = np.load('{}{}{}'.format('Nathan Fake ', lim, '/d.npy'))
K_val = np.load('{}{}{}'.format('Nathan Fake ', lim, '/k.npy'))
...
while NAE_lim == False:
    ...
    if NAE_Emily < 0.1 or np.abs(NAE_current - NAE_Emily)/NAE_current < 0.01:
        NAE_lim = True
        stop = timeit.default_timer()

    NAE_current = NAE_Emily
